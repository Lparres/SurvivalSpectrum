...
export default class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        var container1 =new DicContainer(this,-200,-320, 1);
        centro.add(container1);

        var container2 = new DicContainer(this,200,-320,2);
        centro.add(container2);

        var container3 = new DicContainer(this,-200,-180,3);
        centro.add(container3);

        var container4 = new DicContainer(this,200,-180,4);
